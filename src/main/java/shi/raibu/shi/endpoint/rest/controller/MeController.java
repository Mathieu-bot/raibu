...
@Tag(
    name = "User Profile",
    description = "Endpoints for managing current user profile and preferences")
...
public class MeController {
  ...
  @Operation(
      ...
      description = "Returns the matchmaking-related preferences for the authenticated user")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Operation(
      ...
      description =
          "Updates the matchmaking-related preferences for the authenticated user. All fields are"
              + " optional.")
  @ApiResponses(
      value = {
  ...
  @Operation(
      ...
      description = "Allows the authenticated user to update their preferred country code")
  @ApiResponses(
      value = {
